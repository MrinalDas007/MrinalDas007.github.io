                        ...
                        <div class="col-md-3 text-center">
                            <ul class="list-unstyled mb-0">
                                <li><i class="fas fa-map-marker-alt fa-2x"></i>
                                    <p className='text-center d-flex justify-content-center align-items-center'><GoLocation style={{ marginRight: "4px", fontSize: "22px" }} /> Kasba, Kolkata</p>
                                </li>

                                <li><i class="fas fa-phone mt-4 fa-2x"></i>
                                    <p className='text-center d-flex justify-content-center align-items-center'><BsTelephoneOutbound style={{ marginRight: "8px", fontSize: "22px" }} /> +91 7980643404</p>
                                </li>

                                <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                                    <p className='text-center d-flex justify-content-center align-items-center'><MdOutlineEmail style={{ marginRight: "8px", fontSize: "22px" }} /> das.mrinal1298@gmail.com</p>
                                </li>
                            </ul>
                        </div>
                    </div>
